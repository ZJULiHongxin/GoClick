...
from utils.data_utils.misc import encode_image
...
class DOUBAO:
    ...
    def get_model_response(self, prompt: str, images: list = None, use_img_url: bool = True, logprob: bool = False, use_system: bool = True, sys_prompt: str = '', temperature: float | None = None, num_gen: int = 1, timeout: int = 60, reasoning_effort: str ="medium"):
        img = images[0]
